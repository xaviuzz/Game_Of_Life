...
describe "In the Conway's game of life " do
  ...
  xit "Any live cell with fewer than two live neighbours dies, as if caused by underpopulation" do
    neighbours = 1
  ...
  xit "Any live cell with more than three live neighbours dies, as if by overcrowding" do
    neighbours = 4
  ...
  xit "Any live cell with two or three live neighbours lives on to the next generation" do
    neighbours = 2
  ...
  xit "Any dead cell with exactly three live neighbours becomes a live cell." do
